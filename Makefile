...
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0.42], XML::Smart=>q[1.006009], LWP::UserAgent=>q[2.033], LWP::Simple=>q[1.41], HTTP::Request::Common=>q[1.26] }
#     VERSION => q[0.0.2]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     test => { TESTS=>q[t/00.load.t t/kwalitee.t t/perlcritic.t t/pod-coverage.t t/pod.t] }
...
TEST_FILE = test.pl
TEST_FILES = t/00.load.t t/kwalitee.t t/perlcritic.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
# End.
# Postamble by Module::Install 0.650
